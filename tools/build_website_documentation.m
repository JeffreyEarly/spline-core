...
classes = {'BSpline','TensorSpline','InterpolatingSpline','ConstrainedSpline','TrajectorySpline'};
...
for iName=1:length(allClasses)
    ...
    classDocumentation(iName) = ClassDocumentation(className,  nav_order=currentNavOrder,  websiteRootURL=websiteRootURL,  buildFolder=buildFolder,  websiteFolder=currentWebsiteFolder,  parent=currentParent,  excludedSuperclasses=excludedSuperclasses,  excludedMethodNames=excludedMethodNames);
end
