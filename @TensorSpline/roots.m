...
if self.numDimensions ~= 1
    error('TensorSpline:roots:UnsupportedDimension', ...
        'roots is only defined for one-dimensional TensorSpline objects.');
end

spline1D = BSpline(self.K, self.tKnot_{1}, self.xi(:), ...
