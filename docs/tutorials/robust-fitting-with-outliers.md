...
nav_order: 3
mathjax: true
permalink: /tutorials/robust-fitting-with-outliers
---
...
Source: `Examples/Tutorials/RobustFittingWithOutliers.m`
...
![Changing the distribution from normal to Student-t makes the fit less sensitive to a few large outliers.](./robust-fitting-with-outliers/robust-fit-comparison.png)

*Changing the distribution from normal to Student-t makes the fit less sensitive to a few large outliers.*
...
![The final weights show which observations the Student-t fit decided to trust less.](./robust-fitting-with-outliers/robust-fit-weights.png)

*The final weights show which observations the Student-t fit decided to trust less.*
