...
Source: `Examples/Tutorials/IntroductionToBSplines.m`
...
![InterpolatingSpline applied to the same seven observations for orders K = 1 through 4. Rows show spline order, columns show the spline and its nonzero derivatives. The vertical gray lines mark knot locations.](./introduction-to-b-splines/interpolating-splines-by-order.png)

*InterpolatingSpline applied to the same seven observations for orders K = 1 through 4. Rows show spline order, columns show the spline and its nonzero derivatives. The vertical gray lines mark knot locations.*
...
![One B-spline basis function and its derivatives for orders K = 1 through 4. Each increase in order broadens the support and raises the continuity by one derivative.](./introduction-to-b-splines/bspline-basis-and-derivatives.png)

*One B-spline basis function and its derivatives for orders K = 1 through 4. Each increase in order broadens the support and raises the continuity by one derivative.*
