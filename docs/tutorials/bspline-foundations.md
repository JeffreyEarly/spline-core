...
nav_order: 7
mathjax: true
permalink: /tutorials/bspline-foundations
---
...
Source: `Examples/Tutorials/BSplineFoundations.m`
...
![Increasing the spline degree raises the local polynomial order and the continuity between neighboring pieces.](./bspline-foundations/interpolants-by-degree.png)

*Increasing the spline degree raises the local polynomial order and the continuity between neighboring pieces.*
...
![The low-level BSpline construction reproduces the same cubic interpolant as InterpolatingSpline when the same canonical knot sequence is used.](./bspline-foundations/explicit-basis-construction.png)

*The low-level BSpline construction reproduces the same cubic interpolant as InterpolatingSpline when the same canonical knot sequence is used.*
...
![Repeating an interior knot makes the cubic basis function less smooth and more localized near that knot.](./bspline-foundations/repeated-knot-comparison.png)

*Repeating an interior knot makes the cubic basis function less smooth and more localized near that knot.*
