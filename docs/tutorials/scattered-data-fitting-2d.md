...
nav_order: 7
mathjax: true
permalink: /tutorials/scattered-data-fitting-2d
---

# Scattered Data Fitting in 2D
...
Source: `Examples/Tutorials/ScatteredDataFitting2D.m`
...
![Larger dataDOF produces fewer splines per coordinate direction, which reduces model size and yields a smoother scattered-data fit.](./scattered-data-fitting-2d/scattered-fit-transect.png)

*Larger dataDOF produces fewer splines per coordinate direction, which reduces model size and yields a smoother scattered-data fit.*
