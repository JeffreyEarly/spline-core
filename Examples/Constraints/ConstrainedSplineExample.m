...
defaultSpline = ConstrainedTensorSpline(t, x, K=K, distribution=distribution);

selectedFreeSpline = [];
selectedConstrainedSpline = [];
if ~isempty(selectedCase.tKnot)
    selectedFreeSpline = ConstrainedTensorSpline(t, x, ...
        K=K, ...
        tKnot={selectedCase.tKnot}, ...
        distribution=distribution);
end
if ~isempty(selectedCase.pointConstraints)
    selectedConstrainedSpline = ConstrainedTensorSpline(t, x, ...
        K=K, ...
        tKnot={selectedCase.tKnot}, ...
        distribution=distribution, ...
        pointConstraints=selectedCase.pointConstraints);
end
